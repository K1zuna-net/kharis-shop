...
<body>
  ...
  <form action="" method="post">
    ...
    <div>
      <div class="item-box">
        <div class="item-img">
          <img src="../../imgs/face wash/ニベア２.png" alt="ニベア クリームケア 洗顔料 しっとり" />
          <h2 class="item_name">
            ニベア クリームケア 洗顔料<br />しっとり
          </h2>
        </div>
        <div>
          <p class="item-text">
          ...
          <div class="quan_btn">
            ...
            <input type="hidden" name="item" value="ニベア クリームケア 洗顔料 しっとり">
