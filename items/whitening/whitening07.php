...
<div id="wrapper">
  ...
  <form action="" method="post">
    <div>
      <div class="item-box">
        <div class="item-img">
          <img src="../../imgs/whiting/キュレル美白.png" alt="キュレル美白 " width="500" height="500" />
          <h2 class="item_name">キュレル美白ケア</h2>
        </div>
        <div>
          <p class="item-text">
            高浸透性処方の美白美容液。シミ・ソバカスを防ぐ。<br>
            肌に溶けこむようになじみ、潤い続く使い心地。<br />
            無香料・無着色・アルコールフリー
          </p>
          ...
          <div class="quan_btn">
            ...
            <input type="hidden" name="item" value="キュレル美白ケア">
