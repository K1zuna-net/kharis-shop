...
<div id="wrapper">
    ...
    <form action="" method="post">
        ...
        <div>
            <div class="item-box">
                <div class="item-img">
                    <img src="../../imgs/moisturizer/ちふれ.png" alt="" />
                    <h2 class="item_name">ちふれ<br /></h2>
                </div>
                <div>
                    <p class="item-text">
                        美白成分アルブチンと安定型ビタミンＣ誘導体によるダブルのアプローチで、
                        メラニンの生成をおさえ、シミ・ソバカスを防ぐ薬用美白化粧水<br>
                        なめらかに肌になじんで、しっとりうるおう肌にととのえます。<br>
